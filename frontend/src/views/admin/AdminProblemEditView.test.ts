...
describe('administrator publish gate', () => {
  it('shows structured readiness issues without hidden fields', async () => {
    ...
    store.problem = { id: 1, title: '测试题', slug: 'test', difficulty: 'easy', source: null, accepted_count: 0, submission_count: 0, acceptance_rate: 0, tags: [], description: 'd', input_description: 'i', output_description: 'o', data_constraints: 'n', sample_input: '', sample_output: '', sample_explanation: 'e', time_limit_ms: 1000, memory_limit_mb: 256, created_at: '', updated_at: '', visibility: 'draft', created_by: null }
