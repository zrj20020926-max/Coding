  ...
  <div class="app-shell">
    <header class="site-header">
      ...
      <div class="header-actions">
        ...
        <RouterLink class="mobile-guide-link" to="/guide">手册</RouterLink>
